...
# Skeleton morphometry lives in its own module (fluorostats.skeleton); it is
# re-exported here for backwards compatibility.
from .skeleton import skeleton_metrics, prune_skeleton, n_junction_nodes  # noqa: F401
